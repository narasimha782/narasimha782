...
|---|---|---|
|  **PDF Summarization Web App** | HTML, CSS, JS, Java | Web app to upload PDFs and auto-generate summaries with a clean responsive UI *(Team Lead)* |
|  **Online Student Result Management System** | HTML, CSS, JS, Java | Web-based CGPA calculator from uploaded mark sheets with logic-based processing |

--
### Achievements

-  **Finalist — Smart India Hackathon (SIH) 2025** (Software Edition, Govt. of India)
